...
export const ROUND_COLUMNS = {
  ...
  number: `${ROUND_TABLE}.number` as const,
...
export const ROUND_REFS = {
  ...
  number: () => db.ref('number').withSchema(ROUND_TABLE),
...
export type RoundUpdateData = Partial<Omit<Round, 'tournament_id' | 'created_at' | 'updated_at'>>;
